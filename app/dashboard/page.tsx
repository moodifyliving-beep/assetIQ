  ...
  return (
    <DashboardLayout>
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatsCard label="Portfolio Value" value={dashboardStats.portfolioValue} icon={DollarSign} change={dashboardStats.totalROI} changeType={parseFloat(dashboardStats.totalROI) >= 0 ? "positive" : "negative"} />
          <StatsCard label="Properties Owned" value={dashboardStats.propertiesOwned} icon={Home} change="" changeType="positive" />
          <StatsCard label="Total ROI" value={dashboardStats.totalROI} icon={TrendingUp} change="" changeType={parseFloat(dashboardStats.totalROI) >= 0 ? "positive" : "negative"} />
          <StatsCard label="Royalty Earnings" value={dashboardStats.royaltyEarnings} icon={Coins} change="" changeType="positive" />
        </div>
        )}
